...
function getMainReplyKeys(){
    ...
    if($botState['agencyState'] == "on" && $userInfo['is_agent'] == 1){
        ...
        if ($botState['sellState'] == "on" || $from_id == $admin || $userInfo['isAdmin'] == true) {
            $mainKeys[] = [['text'=>$buttonValues['my_subscriptions']],['text'=>$buttonValues['buy_subscriptions']]];
        } else {
            $mainKeys[] = [['text'=>$buttonValues['my_subscriptions']]];
        }
    ...
    $mainKeys[] = [['text'=>$buttonValues['invite_friends']],['text'=>$buttonValues['my_info']]];

    if ($botState['sharedExistence'] == "on" && $botState['individualExistence'] == "on") {
        $mainKeys[] = [['text'=>$buttonValues['shared_existence']],['text'=>$buttonValues['individual_existence']]];
    } elseif ($botState['sharedExistence'] == "on") {
        $mainKeys[] = [['text'=>$buttonValues['shared_existence']]];
    } elseif ($botState['individualExistence'] == "on") {
        $mainKeys[] = [['text'=>$buttonValues['individual_existence']]];
    }

    $mainKeys[] = [['text'=>$buttonValues['application_links']],['text'=>$buttonValues['my_tickets']]];
